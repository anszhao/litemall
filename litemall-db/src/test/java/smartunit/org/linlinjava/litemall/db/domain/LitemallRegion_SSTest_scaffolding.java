...
public class LitemallRegion_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "org.linlinjava.litemall.db.domain.LitemallRegion"; 
  ...
  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(LitemallRegion_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LitemallRegion_SSTest_scaffolding.class.getClassLoader()); 
