...
public class LitemallRegionExample_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "org.linlinjava.litemall.db.domain.LitemallRegionExample"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.linlinjava.litemall.db.domain.LitemallRegionExample$Criteria", false, LitemallRegionExample_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.linlinjava.litemall.db.domain.LitemallRegionExample$Criterion", false, LitemallRegionExample_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.linlinjava.litemall.db.domain.LitemallRegionExample$ICriteriaWhen", false, LitemallRegionExample_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.linlinjava.litemall.db.domain.LitemallRegionExample$IExampleWhen", false, LitemallRegionExample_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(LitemallRegionExample_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LitemallRegionExample_SSTest_scaffolding.class.getClassLoader()); 
