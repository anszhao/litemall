...
public class LitemallLogExample_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "org.linlinjava.litemall.db.domain.LitemallLogExample"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.linlinjava.litemall.db.domain.LitemallLogExample$Criteria", false, LitemallLogExample_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.linlinjava.litemall.db.domain.LitemallLogExample$ICriteriaWhen", false, LitemallLogExample_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.linlinjava.litemall.db.domain.LitemallLogExample$IExampleWhen", false, LitemallLogExample_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(LitemallLogExample_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LitemallLogExample_SSTest_scaffolding.class.getClassLoader()); 
