...
public class LitemallCategory_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "org.linlinjava.litemall.db.domain.LitemallCategory"; 
  ...
  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(LitemallCategory_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LitemallCategory_SSTest_scaffolding.class.getClassLoader()); 
